module Remoppy
  module Commands
    class Generator
      ...
      def lib_dir_path
        File.expand_path Remoppy.configuration.lib_dir_path, target_dir
      end

      def scripts_dir_path
        File.expand_path Remoppy.configuration.scripts_dir_path, target_dir
      end

      def config_file_path
        File.expand_path Remoppy.configuration.config_file_path, template_dir
      end
